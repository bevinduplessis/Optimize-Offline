...
If ($SystemApps.IsPresent)
{
    ...
    Write-Host "                Microsoft.BioEnrollment"
    Write-Host "                Microsoft.MicrosoftEdgeDevToolsClient"
    Write-Host "                Microsoft.MicrosoftEdge"
    Write-Host "                Microsoft.PPIProjection"
    Write-Host "                Microsoft.Windows.ContentDeliveryManager"
    Write-Host "                Microsoft.Windows.SecHealthUI - (Windows Defender)"
    Write-Host "                Microsoft.XboxGameCallableUI  - (Xbox Services and Drivers)"
    Write-Host "                Microsoft.Windows.SecureAssessmentBrowser"
    Write-Host "                Microsoft.Windows.ParentalControls"
    Start-Sleep 5
...
If ($Packages.IsPresent)
{
    ...
    Write-Host "Safe to Remove:"
    Write-Host "               App.Support.QuickAssist"
    Write-Host "               Browser.InternetExplorer"
    Write-Host "               Hello.Face"
    Write-Host "               Hello.Face.Migration"
    Write-Host "               MathRecognizer"
    Write-Host "               Media.WindowsMediaPlayer"
    Write-Host "               OneCoreUAP.OneSync"
...
If ($Registry.IsPresent)
{
    ...
    #****************************************************************
    Write-Output "Disable this publisher could not be verified message when running an executable." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Associations" -Name "LowRiskFileTypes" -Value '.zip;.rar;.nfo;.txt;.exe;.bat;.vbs;.com;.cmd;.reg;.msi;.htm;.html;.gif;.bmp;.jpg;.avi;.mpg;.mpeg;.mov;.mp3;.m3u;.wav;' -Type String
    #****************************************************************
    Write-Output "Enabling Remote Desktop." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKLM_SYSTEM\ControlSet001\Control\Terminal Server" -Name "fDenyTSConnections" -Value 0 -Type DWord
    #****************************************************************
    Write-Output "Setting PowerShell Execution Policy " >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKLM_SOFTWARE\Microsoft\PowerShell\1\ShellIds\Microsoft.PowerShell" -Name "ExecutionPolicy" -Value 'Bypass' -Type String
    Set-KeyProperty -Path "HKLM:\WIM_HKLM_SOFTWARE\WOW6432Node\Microsoft\PowerShell\1\ShellIds\Microsoft.PowerShell" -Name "ExecutionPolicy" -Value "Bypass" -Type String
    #****************************************************************
    Write-Output "Disabling Network Level Authentication Requirement For Remote Desktop." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKLM_SYSTEM\ControlSet001\Control\Terminal Server\WinStations\RDP-Tcp" -Name "UserAuthentication" -Value 0 -Type DWord
    #****************************************************************
    Write-Output "Disabling Remote Assistance." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKLM_SYSTEM\ControlSet001\Control\Remote Assistance" -Name "fAllowToGetHelp" -Value 0 -Type DWord
    #****************************************************************
    ...
    #****************************************************************
    Write-Output "Disabling Automatic Driver Update." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKLM_SOFTWARE\Microsoft\Windows\CurrentVersion\DriverSearching" -Name "SearchOrderConfig" -Value 0 -Type DWord
    Set-KeyProperty -Path "HKLM:\WIM_HKLM_SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate" -Name "ExcludeWUDriversInQualityUpdate" -Value 1 -Type DWord
    #****************************************************************
    Write-Output "Disabling HomeGroup." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKLM_SOFTWARE\Policies\Microsoft\Windows\HomeGroup" -Name "DisableHomeGroup" -Value 1 -Type DWord
    #****************************************************************
    Write-Output "Disabling Compatibility Telemetry." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKLM_SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\CompatTelRunner.exe" -Name "Debugger" -Value '%windir%\\system32\\taskkill.exe' -Type String
    #****************************************************************
    Write-Output "Disable Gathering Information About Your Pc To Target Builds Through Windows Update." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKLM_SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\CompatTelRunner.exe" -Name "Debugger" -Value '%windir%\\system32\\taskkill.exe' -Type String
    #****************************************************************
    Write-Output "Enable Verbose Status Messages When You Sign In/out Of Windows." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKLM_SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System" -Name "VerboseStatus" -Value 1 -Type DWord
    #****************************************************************
    ...
    Set-KeyProperty -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Themes\Personalize" -Name "AppsUseLightTheme" -Value 0 -Type DWord
    #****************************************************************
    ...
    #****************************************************************
    Write-Output "Disable windows snapping to the edge of the screen (Multi-Monitor)." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKCU\Control Panel\Desktop" -Name "WindowArrangementActive" -Value 0 -Type DWord
    #****************************************************************
    ...
    #****************************************************************
    Write-Output "Enable Showing All System Tray Icons." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer" -Name "EnableAutoTray" -Value 0 -Type DWord
    #****************************************************************
    ...
    #****************************************************************
    Write-Output "Increase Keyboard Repeat Rate." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKCU\Control Panel\Accessibility\Keyboard Response" -Name "Flags" -Value 122 -Type String
    #****************************************************************
    Write-Output "Increase Keyboard Repeat Rate." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKCU\Control Panel\Desktop\Keyboard" -Name "KeyboardDelay" -Value 0 -Type DWord
    #****************************************************************
    Write-Output "Disabling Toggle Keys Prompt." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKCU\Control Panel\Accessibility\ToggleKeys" -Name "Flags" -Value 58 -Type String
    #****************************************************************
    
    Write-Output "Set Desktop Default Background Color to Black." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKCU\Control Panel\Colors" -Name "Background" -Value '0 0 0' -Type String
    #****************************************************************
    
    Write-Output "Set Small Desktop Icon Size." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\Shell\Bags\1\Desktop" -Name "IconSize" -Value 16 -Type DWord
    #****************************************************************
    
    Write-Output "Disable Hide file extensions In Explorer" >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced" -Name "HideFileExt" -Value 0 -Type DWord
    #****************************************************************
    
    Write-Output "Enable Show Hidden Files In Explorer" >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced" -Name "Hidden" -Value 1 -Type DWord
    #****************************************************************
        
    Write-Output "Enable Expand To Current Folder In The Left Panel In Explorer" >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced" -Name "NavPaneExpandToCurrentFolder" -Value 1 -Type DWord
    #****************************************************************

    
    Write-Output "Set Auto Arrange Desktop Icons." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\Shell\Bags\1\Desktop" -Name "FFLAGS" -Value 1075839524 -Type DWord
    #****************************************************************
    Write-Output "Show Full File Pperation Details." >> $RegLog
    #****************************************************************
    Set-KeyProperty -Path "HKLM:\WIM_HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\OperationStatusManager" -Name "EnthusiastMode" -Value 1 -Type DWord
    #****************************************************************
...
If ($Additional.IsPresent -and (Test-Path -Path $AdditionalConfigPath))
{
    ...
    If ($ConfigVars.Utilities -eq $true -and (Test-Path -Path "$AdditionalPath\Utilities"))
    {
        $Host.UI.RawUI.WindowTitle = "Copying Utilities to the Image."
        Out-Log -Info "Copying Utilities to the Image."
        #Out-Log -Info "Creating Folder '$MountFolder\Windows\Utilities'"
        New-Item -Path "$MountFolder\Windows\Utilities" -ItemType Directory -Force | Out-Null
        $Utilities = Get-ChildItem -Path "$AdditionalPath\Utilities" -File -ErrorAction SilentlyContinue
        $Utilities | ForEach-Object { 
        #Out-Log -Info "Copying '$($_.FullName)' to '$MountFolder\Windows\Utilities'"
        Copy-Item -Path $_.FullName -Destination "$MountFolder\Windows\Utilities\" -ErrorAction SilentlyContinue 
      }
        Start-Sleep 3
    }
